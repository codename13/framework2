...
.method private disableQos(I)Z
    ...
    const-string v3, "disabling qos for id: "
    ...
    .line 432
    .local v0, mPhone:Lcom/android/internal/telephony/ITelephony;
    if-nez v0, :cond_0

    .line 433
    const-string v2, "telephony service is unavailable"

    invoke-direct {p0, v2}, Landroid/net/QoSTracker;->logw(Ljava/lang/String;)V
...
.method private enableQoS(Lcom/android/internal/telephony/QosSpec;Ljava/lang/String;)Z
    ...
    .line 402
    :cond_0
    const-string v2, "Input parameter(s) is null"

    invoke-direct {p0, v2}, Landroid/net/QoSTracker;->dloge(Ljava/lang/String;)V
    ...
    const-string v3, "requesting qos with spec: "
...
.method private getQos(I)Z
    ...
    const-string v3, "requesting qos spec for id: "
    ...
    const-string v3, "getQoS returned: "
...
.method private modifyQos(ILcom/android/internal/telephony/QosSpec;)Z
    ...
    .line 474
    const-string v2, "qos spec is null"

    invoke-direct {p0, v2}, Landroid/net/QoSTracker;->dlogw(Ljava/lang/String;)V
    ...
    const-string v3, "modifying qos spec for id: "
...
.method private updateCapabilitiesFromSpec(Lcom/android/internal/telephony/QosSpec;)V
    ...
    const-string v6, "updateCapabilities got spec: "
    ...
    .line 370
    const-string v5, "updateCapabilities expected tx and rx pipes but did not find them"
    ...
    const-string v6, "updated capabilities to: "
...
.method public handleQosEvent(IIILcom/android/internal/telephony/QosSpec;)V
    ...
    const-string v8, "notifying socket of updated capabilities: "
...
.method public resumeQosTransaction()Z
    ...
    const-string v3, "Resuming qos for id: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Landroid/net/QoSTracker;->mQosId:I
    ...
    const-string v3, "QoS state "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Landroid/net/QoSTracker;->mState:Ljava/lang/String;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, " is not the correct state to resume QoS"
    ...
    invoke-direct {p0, v2}, Landroid/net/QoSTracker;->loge(Ljava/lang/String;)V
...
.method public startQosTransaction(Lcom/android/internal/telephony/QosSpec;Ljava/lang/String;)Z
    ...
    const-string v3, "startQosTransaction got called for socket: "
...
.method public stopQosTransaction()V
    ...
    const-string v1, "stopQosTransaction got called for sid: "
...
.method public suspendQosTransaction()Z
    ...
    const-string v3, "Suspending qos for id: "
    ...
    const-string v3, " is not the correct state to suspend QoS"
