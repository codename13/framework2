...
.method private doScan()V
    ...
    invoke-static {v2}, Lcom/android/server/FMRadioService;->access$2100(Lcom/android/server/FMRadioService;)Z
    ...
    invoke-static {v2}, Lcom/android/server/FMRadioService;->access$2200(Lcom/android/server/FMRadioService;)Ljava/util/ArrayList;
    ...
    #getter for: Lcom/android/server/FMRadioService;->mScanChannelList:Ljava/util/ArrayList;
    invoke-static {v4}, Lcom/android/server/FMRadioService;->access$2200(Lcom/android/server/FMRadioService;)Ljava/util/ArrayList;
...
.method public run()V
    ...
    invoke-static {v3, v4}, Lcom/android/server/FMRadioService;->access$2402(Lcom/android/server/FMRadioService;I)I

    .line 2081
    iget-object v3, p0, Lcom/android/server/FMRadioService$ScanThread;->this$0:Lcom/android/server/FMRadioService;

    #getter for: Lcom/android/server/FMRadioService;->mPowerManager:Landroid/os/PowerManager;
    invoke-static {v3}, Lcom/android/server/FMRadioService;->access$2500(Lcom/android/server/FMRadioService;)Landroid/os/PowerManager;
    ...
    invoke-static {v3, v4, v5}, Lcom/android/server/FMRadioService;->access$2602(Lcom/android/server/FMRadioService;J)J

    .line 2094
    iget-object v3, p0, Lcom/android/server/FMRadioService$ScanThread;->this$0:Lcom/android/server/FMRadioService;

    #getter for: Lcom/android/server/FMRadioService;->mScanChannelList:Ljava/util/ArrayList;
    invoke-static {v3}, Lcom/android/server/FMRadioService;->access$2200(Lcom/android/server/FMRadioService;)Ljava/util/ArrayList;
    ...
    invoke-static {v3, v4}, Lcom/android/server/FMRadioService;->access$2202(Lcom/android/server/FMRadioService;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3, v6}, Lcom/android/server/FMRadioService;->access$2102(Lcom/android/server/FMRadioService;Z)Z
    ...
    invoke-static {v4}, Lcom/android/server/FMRadioService;->access$2400(Lcom/android/server/FMRadioService;)I
    ...
    #setter for: Lcom/android/server/FMRadioService;->mScanProgress:Z
    invoke-static {v4, v6}, Lcom/android/server/FMRadioService;->access$2102(Lcom/android/server/FMRadioService;Z)Z
    ...
    #getter for: Lcom/android/server/FMRadioService;->mScanVolume:I
    invoke-static {v5}, Lcom/android/server/FMRadioService;->access$2400(Lcom/android/server/FMRadioService;)I
